        ...
        <div class="bg-white shadow sm:rounded-lg sm:overflow-hidden">
          <div class="divide-y divide-gray-200">
            ...
            <div class="px-4 py-6 sm:px-6">
              <ul v-if="sponsors.length > 0" class="space-y-2">
                <li
                ...
                >
                  <div class="flex justify-between mt-1 text-gray-900">
                    ...
                    <div class="space-x-2">
                      ...
                      <button
                        @click="confirmSponsorDeletion(sponsor)"
                        type="button"
              ...
              <p v-else> Nema unesenih sponzora </p>
            </div>
          </div>
        </div>
      </section>
...
export default {
  ...
  layout: (h, page) =>
    h(
      ...
      {
        resource: "Sponzori",
        indexRoute: "admin.sponsors.index",
  ...
  methods: {
    ...
    confirmSponsorDeletion(sponsor) {
    ...
    destroySponsor() {
      this.$inertia.delete(
        this.route("admin.sponsors.destroy", this.deleteSponsor.id),
        {
