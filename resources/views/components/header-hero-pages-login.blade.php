<div class="relative bg-graylight">
    ...
    <div class="relative max-w-7xl mx-auto py-24 px-6 sm:py-32 lg:px-10">
        ...
        <a href="@if (auth()->user()?->role == 'admin') /admin/dashboard @else
          /user/dashboard @endif" class=" mt-16 inline-block  rounded bg-myindigo px-6 py-3 text-white text-base font-semibold transition ease-in-out duration-700 hover:bg-indigo-800">{{$button}}</a>
    </div>
</div>
