...
<div class="relative py-16 bg-white overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        ...
        <div class="bg-indigo-400 p-4 rounded text-white mt-10">

          <h2>Tko može biti Work and Travel student?</h2>
        ...
        <strong>Independent placement</strong>
        <ul>
        ...
        <p>Za hrvatske studente <strong>Work and Travel program traje od 4.6- 10.10. 2021.</strong> </p>
        ...
        <strong>S obzirom na više od 25 godina iskustva klijenti su nam i poznate kompanije kao:</strong>
        ...
        <strong> Kompanije koje zapošljavaju Work and Travel studente nalaze se širom SAD-a, ali sve su u turističkim lokacijama:</strong>
        ...
        <strong>U njima možeš raditi kao:</strong>
        ...
        <h2>Cijene programa</h2>

        <strong>Independent placement - 7.275,00 HRK - bez:</strong>
        ...
        <strong>Premium - 10.015,00 HRK - bez:</strong>
...
<div class="bg-yellow-50">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:items-center lg:justify-between">
      <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl">
        <span class="block">Zališ započeti prijavu odmah?</span>
        <span class="block text-yellow-600">Samo se trebaš registrirati</span>
      </h2>
