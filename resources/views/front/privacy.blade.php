...
<head>
    ...
    <title>Politika Privatnosti - Suncana Vura</title>
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-lg max-w-prose mx-auto">
        <h1>
          ...
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Politika o privatnosti</span>
        </h1>
      </div>
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        ...
        <h2>1.UVOD</h2>
        <p>Mi u putničkoj agenciji Sunčana vura d.o.o. poštujemo Vašu privatnost, razumijemo njenu važnost i želimo da u potpunosti budete upoznati sa svrhama korištenja Vaših informacija. Molimo da naša pravila o privatnosti pročitate do kraja, a načela našeg poslovanja su sljedeća:</p>
        <ul>
        ...
        <p>Ako niste sigurni ili imate pitanje oko toga kako se prikupljaju ili koriste Vaši podatci, molimo da nas kontaktirate na travelsv@suncana.org <br> <br>
            Naša Pravila o privatnosti u cijelosti možete pročitati u nastavku.
        </p>

        <h2>2. O NAMA</h2>
        <p>SUNČANA VURA d.o.o. za poslovne usluge i turizam sa sjedištem na adresi Kožarska 2, Zagreb, Hrvatska, OIB: 81240702858 <br> <br>
            Voditeljica poslovnice je Elica Rajlić. <br> <br>
            Sukladno GDPR-u (Općoj uredbi zaštite osobnih podataka), SUNČANA VURA d.o.o., djeluje kao voditelj obrade. Ova Pravila (zajedno s drugim odredbama na koje se oni pozivaju) predstavlja osnovu naše obrade bilo kakvih osobnih podataka koje prikupljamo od Vas ili koje nam stavite na raspolaganje. Molimo da ova Pravila pozorno pročitate kako biste u potpunosti razumjeli naš položaj i praksu u pogledu Vaših osobnih podataka i kako ih tretiramo.
        </p>

        <h2>3. KADA PRIKUPLJAMO VAŠE OSOBNE PODATKE</h2>
        ...
        <h2>6. GDJE POHRANJUJEMO I OBRAĐUJEMO VAŠE OSOBNE PODATKE</h2>
        ...
        <h2>7. KAKO ŠTITIMO VAŠE OSOBNE PODATKE</h2>
        ...
        <h2>8. ZA KOJE SVRHE KORISTIMO OSOBNE PODATKE</h2>
        ...
        <h2>9. PRAVNA OSNOVA ZA PRIKUPLJANJE I OBRADU</h2>
        <p>Propisi o zaštiti osobnih podataka uređuju pretpostavke pod kojima se osobni podatci mogu prikupljati i koje mi koristimo kao pravne osnove za prikupljanje i obradu. Te pravne osnove su kako slijedi.</p>
            <h3>9.1. Izvršavanje obveza proizašlih iz kupoprodajnih ugovora</h3>
            ...
            <h3>9.2. Poštivanje pravnih obveza</h3>
        ...
        <h2>10. KOLIKO DUGO ČUVAMO OSOBNE PODATKE</h2>
        ...
        <h2>11. S KIME DIJELIMO OSOBNE PODATKE</h2>
        <p>Kao i mnoge druga trgovačka društva, koristimo određene usluge trećih osoba vezane uz naše poslovanje poput kurirskih službi. Ispod se nalazi popis trgovačkih društava s kojima svakodnevno dijelimo podatke. Popis ne uključuje usluge trgovačkih društava s kojima dijelimo anonimne podatke ili koja pružaju usluge na ad hoc osnovi. Sve navedene poslovne partnere pozorno smo odabrali i pobrinuli smo se da svi pružaju odgovarajuće zaštite sukladno GDPR-u.</p>

        <h2>12. NEWSLETTER I MARKETINŠKE PORUKE</h2>
        ...
        <ul>
            ...
            <li>kontaktirajte nas na travelsv@suncana.org</li>
        </ul>

        <h2>13. OTKRIVANJE VAŠIH OSOBNIH PODATAKA</h2>
        ...
        <h2>15. VAŠA PRAVA PREMA GDPR-U</h2>
        <p>Prema GDPR-u, od 25. svibnja 2018. nadalje imate određena prava koja se odnose na Vaše osobne podatke, te ih u nastavku ukratko opisujemo.</p>
            <h3>15.1. Pravo na ograničenje obrade</h3>
            ...
            <h3>15.2. Pravo na pristup</h3>
            <p>GDPR Vam daje pravo pitati nas koje Vaše osobne podatke imamo i kako ih obrađujemo te pravo dati Vam pristup tim podatcima. <br> <br>
                Svoje pravo možete ostvariti tako da nas kontaktirate (vidi ispod Kako nas možete kontaktirati). Uzmite u obzir da prije obrade bilo kojeg zahtjeva za pristup podatcima moramo potvrditi Vaš identitet, a moguće je i da Vas dodatno kontaktiramo kako bismo bili sigurni da smo razumjeli koje podatke zahtijevate. Nakon što potvrdimo Vaš identitet, tražene informacije ćemo Vam pružiti u roku od 30 dana. <br> <br>
            ...
            <h3>15.3. Pravo na brisanje (Pravo na zaborav)</h3>
            <p>Kao fizička osoba imate pravo zahtijevati brisanje svih svojih osobnih podataka koje imamo. Međutim, uzmite u obzir da to nije apsolutno pravo, pa tako, primjerice, ne nadilazi naše zakonske obveze da čuvamo računovodstvene podatke. <br> <br>
        ...
        <h2>16. IZMJENE NAŠIH PRAVILA O PRIVATNOSTI</h2>
        ...
        <h2>17. KAKO NAS MOŽETE KONTAKTIRATI</h2>
        ...
        <ul>
            <li>možete nam poslati poruku e-poštom na travelsv@suncana.org</li>
            <li>možete nas nazvati radnim danom od 9-17 h na (01) 4813 636</li>
            <li>možete nam pisati na: SUNČANA VURA d.o.o. Kožarska 2, 10000 Zagreb, Hrvatska</li>
        </ul>

        <h2>18. KAKO MOŽETE KONTAKTIRATI NADZORNO TIJELO</h2>
        ...
        <p>Podatke za kontaktiranje AZOP-a možete pronaći ovdje: AZOP KONTAKT</p>
        <strong>Posljednja inačica ovih Pravila o privatnosti objavljena je i stupila na snagu dana 25. svibnja 2018.</strong>
