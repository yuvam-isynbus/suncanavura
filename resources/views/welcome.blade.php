...
<head>
  ...
  <meta name="description"
    content="U 30 godina postojanja postali smo glavni pružatelji usluge vodećim svjetskim i domaćim kompanijama te svim ljubiteljima putovanja i učenja.">
          ...
          <div class="max-w-md mx-auto space-y-4 lg:max-w-5xl lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
            ...
            <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                <div>
                  <h3
                    class="inline-flex px-4 py-1 rounded-full text-sm font-semibold tracking-wide uppercase bg-pink-100 text-pink-600"
                    id="tier-standard">
                    Uskoro
                  </h3>
                </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          ...
          <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            Sunčana vura nudi online prijave za work & travel kao i za zapošljavanje u inozemstvu. Proces prijave je
            jednostavan i <i class="text-yellow-600">user friendly</i> !
          </p>
        </div>
        <div class="my-16">
