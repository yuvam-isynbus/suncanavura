    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="text-lg max-w-prose mx-auto">
        <h1>
          ...
          <span
            class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Work
            & Travel prijava</span>
        </h1>
        <p class="mt-8 text-xl text-gray-500 leading-8">Work and Travel USA je program kulturološke razmjene pod
          pokroviteljstvom State Departmenta. Program je namijenjen studentima koji svoje ljetne praznike žele provesti
          na drugačiji način: radeći, putujući i zabavljajući se u SAD-u!</p>
        <p class="mt-8 text-xl text-gray-500 leading-8">Studenti su zaposleni na jednom ili više sezonskih poslova u
          kompanijama koje posluju u turističkim mjestima i privremeno imaju povećanu potražnju za radnicima. Program
          Work and Travel omogućava stjecanje radnog iskustva (koje budući poslodavci jako cijene!), usavršavanje
          engleskog, osamostaljivanje i stjecanje prijatelja iz cijelog svijeta! </p>
      ...
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        ...
        <div class="bg-yellow-600 p-4 px-10 rounded-lg text-white mt-10">
          ...
          <p>Datume programa propisuje Američka ambasada za svaku zemlju posebno, prema kalendaru nastavnih obaveza u
            pojedinoj zemlji.</p>
          <p>Za hrvatske studente <strong style="color: rgba(253, 230, 138, var(--tw-text-opacity));">Work and Travel
              program traje od 4.6- 10.10. 2021.</strong> </p>
        ...
        <h2>Kompanije</h2>
        <p>U Work & Travel program mogu se prijaviti kompanije koje imaju povećanu sezonsku potrebu za radnom snagom (u
          turističkim mjestima): restorani, zabavni parkovi, hoteli, suvenirnice…</p>

        <strong style="color: rgba(251, 191, 36, var(--tw-text-opacity));">S obzirom na više od 25 godina iskustva
          klijenti su nam i poznate kompanije kao:</strong>
        ...
        <strong style="color: rgba(251, 191, 36, var(--tw-text-opacity));"> Kompanije koje zapošljavaju Work and Travel
          studente nalaze se širom SAD-a, ali sve su u turističkim lokacijama:</strong>
        ...
        <h2>Poslovi</h2>
        <p>Poslovi za Work & Travel studente su početnički poslovi za koje ne trebaš imati iskustvo i nude ga najčešće
          kompanije u uslužnim djelatnostima: restorani, hoteli, golf klubovi, zabavni parkovi, nacionalni parkovi,
          trgovački centri…</p>
        ...
        <div class="bg-yellow-600 p-4 px-10 rounded-lg text-white mt-10">
          ...
          <p>Studenti su plaćeni po satu, a satnica ovisi o vrsti posla i lokaciji.
            ...
            Povrh toga moći ćeš dodatno zaraditi i na drugom poslu koji ćeš tražiti samostalno po dolasku i taj drugi
            posao trebaš prijaviti sponzoru.</p>

          <p>Poslodavci plaću isplaćuju svaka dva tjedna pa trebaš ponijeti minimalno 1000 USD džeparca za početne
            troškove.</p>
        ...
        <div class="bg-yellow-600 p-4 px-10 rounded-lg text-white mt-10">
          ...
          <strong style="color: rgba(253, 230, 138, var(--tw-text-opacity));">Independent placement - 7.275,00 HRK -
            bez:</strong>
        ...
        <ul>
          ...
          <li>životopis sa svim iskustvom koje ste stekli uključujući i volontiranja i praksu, na engleskom, u formatu
            koji se može korigirati</li>
          <li>video</li>
        </ul>

        <p>*ukoliko vam je putovnica istekla možete se prijaviti u program, a kopiju nove putovnice trebamo primiti u
          najkraćem mogućem roku.</p>
        ...
        <p>U sklopu programa potrebno je aplicirati on-line za <strong>J-1 Work and Travel vizu.</strong> Agencija će ti
          pomoći pri svakom koraku, ali intervju svaki student treba osobno obaviti na Američkoj ambasadi.</p>

        <p>U slučaju odbijene vize <strong>VRAĆAMO CIJELOKUPAN IZNOS CIJENE PROGRAMA*</strong> osim u slučaju kad je
          razlog odbijanja netočan, neistinit i/ ili nepredočeni ključni podatak prilikom prijave u Program i kod
          ispunjavanja upitnika za vizu.</p>

        <p>*ne odnosi se na iznos 160 USD uplaćen Američkoj ambasadi za proces obrade zahtjeva za vizu</p>
        <h2>Povrat poreza</h2>
        <p>Američki poslodavci imaju obavezu plaćanja poreza (state i federal taxes) za svakog radnika pa tako i za
          međunarodne studente.
          Budući da nećeš koristiti te beneficije, imaš pravo na povrat poreza za koji apliciraš po povratku u Hrvatsku.
          Mi te možemo uputiti kome da se javiš u vezi povrata poreza.</p>
      </div>
    </div>
  </div>
  <x-footer-register />
